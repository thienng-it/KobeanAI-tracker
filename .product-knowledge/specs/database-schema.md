---
title: "Database Schema (Drizzle ORM)"
type: spec
status: draft
author: "Nguyen Thai Minh Thien (Joseph)"
created: 2026-08-11
updated: 2026-08-11
tags: [database, schema, drizzle, sqlite]
---
...
This spec defines the complete Drizzle ORM SQLite schema for KobeanAI Tracker. The code below can be directly copied by the backend engineer into `server/db/schema.ts`.

---

## Scope

**In scope:** Tables for Workspaces, Sessions, Tags, Skills, Commands, Rules, Agents, and their cross-reference tables. Indexes and TypeScript relations.
**Out of scope:** Business logic and data access layer (queries/mutations).
