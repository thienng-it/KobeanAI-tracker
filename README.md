...
- 🏷️ **Canonical Intent Taxonomy & Noise Filtering**: Automatic categorization into `[Implement]`, `[Fix]`, `[Refactor]`, `[UI/UX]`, `[Docs]`, `[Validate]`, and `[Config]` with real-time workload distribution charts.
